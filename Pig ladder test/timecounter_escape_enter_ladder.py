...
root.title(u'Pig Ladder Test - Time Counter, by Rui Wang, 2021-Apr-23')
...
# Icons
dict_image = {
    'Up':     ['Up',      'ladder.png',   None],
    'Down':   ['Down',    'falldown.png',  None],
    'Left':   ['Left',    'bucket.png',    None],
    'Escape':  ['Escape',   'pause.png',     None],
    'Return':   ['Return',    'preparing.png', None],
...
dict_key   = {
    'Up':     ['Up',      u'Ladder',                 key_Movement, touch_counts,  touch_accumulations],
    'Down':   ['Down',    u'Falldown',                 key_Movement, leave_counts, leave_accumulations],
    'Left':   ['Left',    u'Bucket',                 key_Movement, others_counts,   others_accumulations],
    'Escape':  ['Escape',   u'Pause',                 key_Pause],
    'Return':   ['Return',    u'Next', key_Next],
...
def doSave_(ofile):
    ...
    rpt = u'No., Total times, Total duration, Ladder times, Ladder duration, Falldown times, Falldown duration, Bucket times, Bucket duration\r\n'
...
label_touch = Label(frame_statistics_top, text=u'Ladder:')
...
label_leave = Label(frame_statistics_top, text=u'Falldown:')
...
label_others = Label(frame_statistics_top, text=u'Bucket:')
